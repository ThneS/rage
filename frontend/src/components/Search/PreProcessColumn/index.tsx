...
const PreProcessColumn: React.FC<PreProcessColumnProps> = ({ config, formValues, onValuesChange, result, onExecute, onBack, selectedDocument }) => {
  ...
  if (!selectedDocument) {
    return (
      <Card title="预处理" style={{ height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  return (
    <Card title="预处理" style={{ height: '100%' }}>
...
export default PreProcessColumn;
